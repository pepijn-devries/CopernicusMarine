...
```{r translate, eval=curl::has_internet()}
...
```{r download-translation, eval=curl::has_internet(), message=FALSE, fig.width=4, fig.height=4, fig.alt="Data downloaded using translated query code"}
